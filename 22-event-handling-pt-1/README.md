...
### Demonstrate click on Wikipedia title, change color
...
heading.addEventListener("click", function (event) {
  //
  console.dir(event);
  // where the user clicked, what element triggered it?
  // What are the various properties of said event?
  // check out path, target, etc.
  heading.style.color = "red";
...
- extract articlesArray and put it in data.js
- script src data.js in index.html head, don't need defer
